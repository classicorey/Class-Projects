...
namespace IT481_Unit2_Crooks
{
    public partial class Form1 : Form
    {
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                txtMessageText.Text = "I couldn't do that. There was something wrong with your SQL insertion. Ensure you are only using valid characters.";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                txtMessageText.Text = "I couldn't do that. There was something wrong with your SQL deletion. Ensure the record matches in the database.";
                txtMessageText.ForeColor = System.Drawing.Color.Red;
            }
        }
    }
